                                ...
                                <form>
                                    <div class="row">
                                        <div class="col-lg-12 mt-5 p-5">
                                            <div class="d-grid">
                                                <a href="{{env('GITHUB_URL')}}" target="_blank" class="btn btn-primary">GitHub
                                                    @ {{env('GITHUB_NAME')}}</a>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="text-sm-start">
                            <p class="mb-0">Copyright © <a href="https://www.upd8.com.br/" target="_blank"
                                                           style="color:#fff">UPD8</a> - <a href="{{env('GITHUB_URL')}}"
                                                                                            target="_blank"
                                                                                            class="text-reset">{{env('GITHUB_NAME')}}</a>.
                            </p>
                        </div>
                    </div>
                </div>
